...
# (порог в часах с последней синхронизации, картинка, штраф %, текст)
TIERS = [
    (12, "g7_r0_c0.png", 5,
     "Хехехе… уже 12 часов? Как быстро ты забываешь о своей системе.\n\n"
     "Штраф: −5% ко всем характеристикам."),
    (24, "g7_r0_c1.png", 10,
     "Целые сутки без тебя. Твой рост остановился, твоя сила утекает.\n\n"
     "Штраф: −10% ко всем характеристикам."),
    (66, "g7_r0_c2.png", 0,
