...
# см. applyPendingPenalty() в index.html; бонус за возврат (+10 эксп, COMEBACK_BONUS)
# всегда меньше минимального штрафа (50), так что уйти специально невыгодно
TIERS = [
    (12, "g7_r0_c0.png", 50,
     "Хехехе… уже 12 часов? Как быстро ты забываешь о своей системе.\n\n"
     "Штраф при следующем заходе: −50 эксп."),
    (24, "g7_r0_c1.png", 100,
